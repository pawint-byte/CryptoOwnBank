...
export const HELP_GUIDES: GuideMeta[] = [
  ...
  },
  {
    ...
    blurb: "Pick the plan that fits — Solo, Family, or Estate.",
    readMinutes: 1,
    section: "legacy",
    status: "coming",
  ...
  },
  {
    ...
    blurb: "Name a person, pick a wallet template, encrypt the seed vault with a passphrase.",
    readMinutes: 4,
    section: "legacy",
    status: "coming",
    next: "legacy-test",
  },
  {
    ...
    blurb: "Rehearse the recovery so you know it works. Decrypt the vault yourself.",
    readMinutes: 3,
    section: "legacy",
    status: "coming",
  },
