...
export const SIGNERS: SignerCapability[] = [
  ...
  },
  {
    ...
    note: "NFC card wallets are mobile-first and don't work over desktop web. A direct integration is on the roadmap once vault-deposit support is confirmed.",
  },
  {
    id: "air-gapped",
    name: "Air-gapped (Keystone / Coldcard-style)",
    ...
    note: "Fully offline signing is the highest security bar. We'll add it once these devices can cleanly read and clear-sign vault transactions.",
  },
];
