...
const faqGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "Does interest compound in Soil vaults? Do I need to manually reinvest?",
        a: "No manual reinvest needed \u2014 interest compounds automatically. When you leave earned interest in the vault (i.e. you don\u2019t withdraw it), it gets added to your vault position. Future interest is then calculated on the larger balance (original deposit + all accumulated interest), so your yield snowballs over time without you doing anything. Example: deposit $10,000 at 6% APR \u2192 after month 1 you\u2019ve earned ~$50, so month 2\u2019s interest is calculated on ~$10,050, month 3 on ~$10,100, and so on. Your effective annual yield ends up exceeding the nominal APR. You have two options: (1) Set-and-forget: leave everything in the vault and let compounding do its work. (2) Withdraw Interest Only: pull just the earnings anytime (your principal + prior accumulated interest keeps compounding). There is no \u201Creinvest\u201D button because it happens automatically. Premium members can also auto-schedule weekly/monthly interest withdrawals. Interest continues accruing even during vault notice/cooldown periods.",
      },
      {
