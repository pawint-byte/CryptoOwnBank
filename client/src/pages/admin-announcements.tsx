...
const SAVED_DRAFTS: AnnouncementDraft[] = [
  {
    title: "New: Your Sovereignty Cockpit — One Calm Home for the State of Everything You Own",
    description: "Banks used to hold one thing for you that had nothing to do with money: the memory of what you own and who can reach it. When you become your own bank, that job becomes yours too. The new Sovereignty Cockpit is where it lives.\n\nWhat it is:\n\nOne calm home \u2014 at cryptoownbank.com/cockpit \u2014 that shows the true state of your sovereignty at a glance. Not your balances ticking up and down. Whether everything you own is secured, written down, reachable by the right people, and ready to pass on.\n\nThe six things it tracks:\n\n\u2022 Secured \u2014 your keys are in your control.\n\u2022 Documented \u2014 there's a written record of what exists and where.\n\u2022 Continuous \u2014 someone you trust could reach it if you no longer could.\n\u2022 Productive \u2014 your holdings can earn, if and when you want them to.\n\u2022 Liquid without selling \u2014 you can borrow against what you own instead of selling it.\n\u2022 Tested \u2014 you've actually checked that recovery works.\n\nFor each one you set a simple status and the date you last checked it. The cockpit quietly shows you when something is due for another look \u2014 no streaks, no guilt, no daily nagging. You decide what \"done\" means.\n\nThe access-continuity record:\n\nFor each wallet you can write down the route to it \u2014 where the device is, who knows the steps, what someone would need to do. Never the secret itself. We say it plainly on the page: write the route, never the seed phrase, key, or PIN. This is the part the bank used to remember for your family. Now it's yours, in your own words.\n\nIt opens on your reason:\n\nWhether you're escaping a system you don't trust, guarding a family, providing for people who depend on you, running an operation, or just exploring \u2014 the cockpit leads with the part that matters most to you.\n\nThe honest part:\n\nEverything in your cockpit stays on your device. We don't see it, we don't keep it on a server, we don't score you, and we never hold your funds or keys. It's a map of what you own \u2014 never the vault, never the secret. Self-attested, private, and yours.\n\nOpen it from the sidebar under Home, or go to cryptoownbank.com/cockpit.\n\nKnow where you stand \u2014 The CryptoOwnBank team",
    ctaLabel: "Open my Sovereignty Cockpit",
    ctaUrl: "https://cryptoownbank.com/cockpit",
    audienceTier: "all",
  },
  {
