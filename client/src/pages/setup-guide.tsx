    ...
    steps: [
      ...
      },
      {
        ...
        details: [
          ...
          "To withdraw interest manually: go to OwnBank → Withdraw Interest → select a vault → sign in Xaman",
          "To automate: enable 'Earn & Accumulate' on the Withdraw page — set a threshold (e.g., $5), pick a frequency, and the system pushes Xaman notifications when interest is ready. If Auto-Buy XRP is also on, all vault interest is combined into one DEX order for a better fill",
        ],
        tip: "You can split RLUSD across both vaults — some in Treasury for quick access, some in CREDIT+ for higher yield. With Earn & Accumulate enabled (Premium/Pro), your interest is automatically withdrawn and converted to XRP — hands-free.",
      },
      {
        number: 9,
        icon: BarChart3,
    ...
    steps: [
      ...
      },
      {
        ...
        details: [
          ...
          "Premium/Pro: enable 'Earn & Accumulate' on the Withdraw page to automate interest withdrawals — interest from all vaults is combined into a single DEX order for XRP conversion",
        ],
