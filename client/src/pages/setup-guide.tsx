...
const toolkits: Toolkit[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        details: [
          'Ledger Nano X (~$149) — Bluetooth, pairs with Xaman, most popular for XRPL. Buy ONLY from <a href="https://shop.ledger.com/pages/referral-program?referral_code=H7DFZEAP8RPK4" target="_blank" rel="noopener noreferrer" class="text-[#00A4E4] underline hover:text-[#0090c9]">ledger.com</a>',
          'ELLIPAL Titan (~$139) — Air-gapped (no Bluetooth/USB), uses QR codes. Buy from <a href="https://www.ellipal.com/?rfsn=9012773.864657d" target="_blank" rel="noopener noreferrer" class="text-[#00A4E4] underline hover:text-[#0090c9]">ellipal.com</a>',
          ...
          'CypheRock X1 (~$159) — Seedless recovery with key cards, no single point of failure. Buy from <a href="https://cypherock.com/store/?ref=PETER.WINT" target="_blank" rel="noopener noreferrer" class="text-[#00A4E4] underline hover:text-[#0090c9]">cypherock.com</a>',
      ...
      },
      {
        ...
        tip: "The free tier gives you access to all XRPL tools (Token Manager, DEX Trading, Send & Receive), plus 1 wallet address and 1 price alert. Upgrade to Premium when you need more.",
      },
      {
        number: 8,
        icon: Landmark,
        ...
        details: [
          ...
          "Interest accrues daily and compounds automatically — your interest earns interest. At 8% APR, $10,000 grows to $14,918 in 5 years without you doing anything",
          "To withdraw: go to OwnBank → Vault Positions → click 'Withdraw via Soil' — this opens Soil's app where you complete the withdrawal. Soil only supports full withdrawal (principal + interest together)",
          "Once RLUSD returns to your wallet, set up DCA (Premium/Pro) to automatically convert it to XRP on a schedule — so your RLUSD doesn't sit idle",
        ],
        tip: "You can split RLUSD across both vaults — some in Liquid for quick access, some in Credit+ for higher yield. Set up a DCA order before withdrawing so your RLUSD converts to XRP automatically.",
      },
      {
        number: 9,
        icon: BarChart3,
        ...
        details: [
          ...
          "Premium members get unlimited wallet addresses, full transaction history, and tax reports",
        ],
  ...
  },
  {
    ...
    steps: [
      {
        ...
        tip: "The free tier gives you 1 wallet address, 1 price alert, and 7-day transaction history. If you have multiple wallets, Premium ($29/mo or $199/yr) unlocks unlimited everything.",
      },
      {
        number: 2,
        icon: Link2,
        title: "Import Your Exchange Data",
        description: "Upload CSV transaction history from your exchanges to see everything in one dashboard.",
        details: [
          "Go to Import Data in the sidebar",
          "Export your transaction history from your exchange (Coinbase, Kraken, Crypto.com, Binance, etc.) as a CSV file",
          "Upload the CSV file — we support Ledger Live, Yahoo Finance, CoinTracker, and generic CSV formats",
          "Your transactions, positions, and tax lots are created automatically",
          "Repeat for each exchange or platform you use",
        ],
        tip: "Most exchanges let you export transaction history from their Settings, Reports, or Statements page. Download a CSV file and upload it here.",
      },
      {
        number: 3,
        icon: Wallet,
      ...
      },
      {
        ...
        details: [
          ...
          "Premium/Pro: set up DCA to automatically convert RLUSD to XRP — withdraw from Soil when ready, and your DCA handles the conversion on schedule",
        ],
    ...
    completionText: "All your wallets and imported exchange data are consolidated in one dashboard. You can see your entire portfolio, track performance, discover yield opportunities, and use XRPL tools for trading, payments, and token management. No more switching between five different apps.",
  },
  {
    id: "business",
    ...
    steps: [
      ...
      },
      {
        ...
        details: [
          ...
          "Interest accrues daily and compounds automatically — your interest earns interest. At 8% APR, $500 RLUSD grows to $742 in 5 years. A bank at 0.5% would give you just $513. Compounding is your biggest advantage — the longer you leave it, the faster it grows",
          "Your position stays in the vault until you choose to withdraw via Soil (full withdrawal only — principal + interest together). This protects your savings from impulse spending",
      ...
      },
      {
        ...
        details: [
          ...
          'Buy only from the manufacturer\'s official website: <a href="https://shop.ledger.com/pages/referral-program?referral_code=H7DFZEAP8RPK4" target="_blank" rel="noopener noreferrer" class="text-[#00A4E4] underline hover:text-[#0090c9]">ledger.com</a>, <a href="https://www.ellipal.com/?rfsn=9012773.864657d" target="_blank" rel="noopener noreferrer" class="text-[#00A4E4] underline hover:text-[#0090c9]">ellipal.com</a>, <a href="https://www.getarculus.com" target="_blank" rel="noopener noreferrer" class="text-[#00A4E4] underline hover:text-[#0090c9]">getarculus.com</a>, <a href="https://www.safepal.com" target="_blank" rel="noopener noreferrer" class="text-[#00A4E4] underline hover:text-[#0090c9]">safepal.com</a>, <a href="https://cypherock.com/store/?ref=PETER.WINT" target="_blank" rel="noopener noreferrer" class="text-[#00A4E4] underline hover:text-[#0090c9]">cypherock.com</a> — never from third-party sellers',
        ],
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        tip: "Compound interest is your secret weapon. $10,000 in the Credit+ vault at 8% APR grows to $10,833 after year 1, $12,712 after year 3, and $22,255 after 10 years. A bank savings account at 0.5% would only give you $10,512 in the same 10 years. The difference: $11,743. Just leave it and let time do the work.",
      },
      {
        number: 7,
        icon: BarChart3,
        title: "Track Yield and Manage Withdrawals",
        description: "Monitor your positions and withdraw when you're ready.",
        details: [
          ...
          "To withdraw: go to CryptoOwnBank → Vault Positions → 'Withdraw via Soil' — Soil only supports full withdrawal (principal + interest together)",
          "Once RLUSD returns to your wallet, your DCA order (if active) converts it to XRP automatically",
          "Premium members get DCA scheduling, full history exports, and tax reports for yield income",
        ],
        tip: "This is the entire point: your RLUSD earns 5-8% APR, your keys stay on your device, and you control when to withdraw. Set up DCA before withdrawing so your RLUSD converts to XRP automatically. Banks pay 0.01%. Exchanges hold your keys. Soil + CryptoOwnBank gives you both: real yield AND real ownership.",
      },
    ],
    completionTitle: "Your Money Is Working for You",
    completionText: "Your RLUSD is earning 5-8% APR in Soil Protocol vaults, compounding daily. Your keys are on your device. Your position is protected until you choose to withdraw. When you're ready, withdraw via Soil, and your DCA converts RLUSD to XRP automatically. Track everything from CryptoOwnBank. This is what 'be your own bank' looks like when the yields are real and the control is yours.",
  },
];
