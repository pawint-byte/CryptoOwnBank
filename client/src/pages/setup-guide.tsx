...
const toolkits: Toolkit[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        tip: "The Ledger Nano X is the most common choice for XRPL because it pairs directly with Xaman via Bluetooth. But any of these work — pick the one that fits your budget and comfort level.",
      },
      {
        number: 3,
        icon: Download,
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: "Someone sends you XRP or RLUSD — this activates your wallet and proves the system works.",
        details: [
          ...
          "Share your wallet address (the 'r...' address from Xaman) with the person paying you",
          "They can also scan your QR code in Xaman (tap 'Receive' to show it)",
          "When they send, the payment arrives in about 4 seconds. You'll see it in your Xaman balance immediately",
          "If nobody you know has XRP yet, you can buy it on an exchange (Coinbase, Kraken, Uphold) using a bank account, debit card, or peer-to-peer purchase — and withdraw it to your wallet",
          "Some regions also have crypto ATMs or peer-to-peer marketplaces (like Bisq) where you can buy XRP with cash or mobile money",
        ],
        tip: "The 10 XRP reserve is locked by the XRPL network as a spam prevention measure — it keeps your account active on the ledger. It's not a fee and it's not lost — it's returned if you ever close the account.",
      },
      {
        number: 4,
        icon: Plus,
        ...
        details: [
          ...
          "Other useful tokens: SOLO (Sologenic ecosystem token) — but RLUSD is the most important for stability",
        ],
        tip: "If you're in a country with high inflation, RLUSD is your hedge. Instead of watching your savings lose value in local currency, hold RLUSD and maintain dollar purchasing power. No bank account needed — just this trust line.",
      },
      {
        number: 5,
        icon: Link2,
      ...
      },
      {
        number: 6,
        icon: PiggyBank,
        title: "Earn Yield on Your Savings (5-8% APR)",
        description: "Deposit RLUSD into Soil Protocol vaults and earn more than any traditional savings account.",
        details: [
          ...
          "Your principal stays locked (protected). Only interest can be withdrawn, keeping your savings safe from impulse spending",
        ],
        tip: "This step requires KYC (identity verification) with Soil Protocol — not with CryptoOwnBank. It's standard for regulated yield products. But the yield is real: 5-8% APR on a dollar-pegged stablecoin, backed by real-world assets.",
      },
      {
        number: 7,
        icon: Globe,
        ...
        details: [
          ...
          "Cross-currency: the XRPL can automatically convert currencies (e.g., XRP → RLUSD) using XRP as a bridge currency",
        ],
        tip: "A $500 remittance through Western Union might cost $15-25 in fees plus a bad exchange rate. The same $500 sent as RLUSD on the XRPL costs less than a penny and arrives in 4 seconds. That's the difference.",
      },
      {
        number: 8,
        icon: Shield,
    ...
    completionText: "You now have a wallet that receives payments from anywhere in the world, holds dollar-stable value (RLUSD), earns 5-8% yield, and settles transactions in 4 seconds for fractions of a penny. Nobody can freeze it, close it, or deny you service. This is financial access without permission — and you built it with a phone and an internet connection.",
  },
  {
    id: "yield",
