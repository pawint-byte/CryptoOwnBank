...
const faqGroups = [
  {
    ...
    items: [
      ...
      {
        q: "What is EVM Swap and how does it work?",
        a: "EVM Swap lets you trade thousands of ERC-20 tokens across 7 chains — Ethereum, Polygon, Arbitrum, Optimism, Base, Avalanche, and BNB Chain — right from CryptoOwnBank. Powered by 1inch, it aggregates the best swap rate across every major DEX (Uniswap, SushiSwap, Curve, Balancer, and dozens more) so you always get the best price. Connect MetaMask (with your Ledger for cold wallet security), select your tokens, review the quote, and confirm. Your swap is signed directly from your wallet — CryptoOwnBank never touches your tokens. For ERC-20 tokens (not native ETH), you'll approve the token spend first, then confirm the swap — two quick signatures. A 1% platform fee is included in the quote. Premium or Pro subscription required.",
      },
      {
