...
const faqGroups = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "EVM Swap lets you trade thousands of ERC-20 tokens on a single chain — Ethereum, Polygon, Arbitrum, Optimism, Base, Avalanche, or BNB Chain. Powered by 1inch, it aggregates the best rate across every major DEX. Cross-Chain Swap goes further — powered by LI.FI, it bridges and swaps tokens across different EVM chains in one flow. XRPL Bridge is our newest addition — powered by Axelar via Squid Router, it lets you bridge assets directly from Ethereum or other EVM chains to native XRP on the XRP Ledger. Connect your EVM wallet, enter your XRPL address, and bridge in minutes. Axelar secures the cross-chain transfer. All three support MetaMask, WalletConnect (50+ mobile wallets), and Ledger hardware wallets. Non-custodial throughout — we never touch your tokens. Premium or Pro subscription required.",
      },
      {
