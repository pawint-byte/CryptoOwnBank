...
const faqGroups = [
  {
    ...
    items: [
      ...
      {
        q: "What is EVM Swap and Cross-Chain Swap?",
        a: "EVM Swap lets you trade thousands of ERC-20 tokens on a single chain — Ethereum, Polygon, Arbitrum, Optimism, Base, Avalanche, or BNB Chain. Powered by 1inch, it aggregates the best rate across every major DEX. Cross-Chain Swap goes further — powered by LI.FI, it bridges and swaps tokens across different chains in one flow. Want to go from ETH on Ethereum to USDC on Polygon? Cross-Chain Swap finds the best route (bridge + swap), shows you every step, estimated time, gas costs, and fees — then you approve it from your wallet. Both support MetaMask (browser extension), WalletConnect (scan a QR code with MetaMask Mobile, Trust Wallet, Rainbow, Coinbase Wallet, or 50+ other mobile wallets), and Ledger hardware wallets. Non-custodial throughout — we never touch your tokens. Premium or Pro subscription required.",
      },
      {
