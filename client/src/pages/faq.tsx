  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "There's a famous line attributed to John D. Rockefeller: \u201COwn nothing, control everything.\u201D Rockefeller used trusts and holding companies to separate legal ownership from practical control \u2014 minimizing liability while maximizing power over assets. Some crypto services have adopted this same playbook: they'll sell you LLCs, institutional custody, and trust structures so that entities own your assets while you supposedly maintain control through them. But here's the problem \u2014 that model inserts third parties into your decisions. A custodian can freeze your account. A trust requires lawyers. An LLC means filings, fees, and someone else's rules. CryptoOwnBank applies the Rockefeller philosophy differently. We don't own your crypto \u2014 and neither does any entity we set up for you, because we don't set up entities. You hold your keys on your own cold wallet. Through that direct ownership, you have complete, unrestricted control: transfer it anywhere, use it to buy goods and services, deposit it into yield vaults, trade on the DEX, send it across borders \u2014 all without anyone's permission. No third party can block, reverse, or restrict your transactions. Think about how XRP works: Ripple controls the release schedule of 1 billion XRP per month from escrow, but once that XRP is in someone's wallet, Ripple has zero ability to stop them from spending it, trading it, or sending it anywhere in the world. The same principle applies to every asset you hold through CryptoOwnBank. We provide the tools \u2014 portfolio tracking, vaults, DEX, payments \u2014 but the moment your assets are in your wallet, no one stands between you and what you do with them. This is the critical difference from CBDCs (Central Bank Digital Currencies), where the money itself is programmable \u2014 governments can code restrictions directly into the currency: where you can spend it, what you can buy, when it expires, or whether your account gets frozen based on criteria you never agreed to. With crypto on a decentralized blockchain, the code serves you. With CBDCs, the code serves whoever wrote it. Own nothing, control everything \u2014 except now you own it AND control it, with no uninvited third party in your decisions.",
      },
    ],
  },
  {
