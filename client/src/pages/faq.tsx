    ...
    items: [
      {
        ...
        a: "CryptoOwnBank was created because exchanges can fail, freeze, or go bankrupt — and when they do, your funds are trapped. FTX. Celsius. Voyager. Mt. Gox. People trusted platforms with billions, and those platforms failed. CryptoOwnBank exists so your crypto is never in anyone else's hands. We built it to solve three problems at once: (1) Full ownership — your wallet stays in your control. We never see or store your private keys. No exchange can freeze your account, no company can go bankrupt with your money, because your money isn't with them. Even if you leave CryptoOwnBank, your crypto stays in your wallet. You're never locked in. (2) Real, higher yields you keep — earn 5–8% fixed APR on RLUSD through Soil Protocol, and keep every cent. No platform fees, no middleman taking a cut. Plus we surface on-chain staking and DeFi yield opportunities across 24 blockchains. (3) Security on your terms — cold wallet for maximum protection, hot wallet for convenience, hardware signing or phone signing. You choose your security level. No uninterested third party in your decision-making process. (4) We bring opportunities to you — our Recommendations Hub analyzes your portfolio and surfaces the best yields, staking, and DeFi you'd otherwise miss. Statement Insights compares your bank rates vs. on-chain yields. You don't have to go looking — the platform brings the information to you.",
      },
      {
        q: "What is CryptoOwnBank?",
        a: "CryptoOwnBank is a non-custodial crypto platform built on one principle: own your crypto, manage it from one interface, and keep all your earnings. Track your entire portfolio across 24 blockchains, earn 5–8% fixed yield on RLUSD through Soil Protocol, trade on native DEXs, and send payments globally — all while your keys stay in your hands. CryptoOwnBank gives you the control and ownership you need while enforcing security the way you want: cold wallet, hot wallet, hardware signing, or phone signing. We clearly distinguish on-chain options (you keep your keys) from custodial options (a company holds your assets). We bring opportunities to you through the Recommendations Hub rather than making you go looking. And if you ever leave CryptoOwnBank, your crypto is still in your wallet — we never hold your assets. Whether you're unbanked, debanked, or simply tired of trusting platforms that can fail — CryptoOwnBank gives you the tools to be your own bank.",
      },
      {
        q: "Why does CryptoOwnBank focus on XRPL and Stellar instead of Ethereum, Solana, or BNB Chain?",
        a: "Because we don't believe in patchwork. Look at what it takes to do a simple token swap on most blockchains today: on Ethereum, you need a MetaMask wallet, connect to Uniswap (a third-party app), approve a smart contract to spend your tokens, pay $5–50 in ETH gas fees, and hope the contract hasn't been exploited — all for one trade. On BNB Chain, it's a different wallet, a different DEX (PancakeSwap), a different gas token. Solana? Another wallet, another aggregator (Jupiter), another set of permissions. Every chain bolts on more third-party apps, more intermediaries, more points of failure. Now look at the XRP Ledger: the decentralized exchange is built into the protocol. There's no Uniswap equivalent because there doesn't need to be — the exchange is the chain itself. You open your Xaman wallet, pick a pair, sign the trade, and it settles in 4 seconds for a fraction of a penny. No smart contract risk. No third-party app to trust. No governance token to hold. No wrapped tokens. No extra gas token. Stellar works the same way — a native DEX at the protocol level, with XLM as the bridge currency. CryptoOwnBank chose these chains deliberately. Our philosophy is: get your assets on the blockchain, use XRP as your universal bridge currency, and the native DEX handles the rest. One chain, one wallet, one bridge — not a patchwork of five apps, three gas tokens, and two browser extensions. We're not against Ethereum or Solana — we track portfolios across 24 chains. But when it comes to trading, payments, and yield, we build on chains where the infrastructure is native, not bolted on by third parties who can change the rules, get hacked, or disappear. That's the difference between building on a foundation and building on a stack of other people's apps.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes — and we strongly encourage it. We accept crypto on 25 blockchains: XRP, RLUSD, BTC, ETH, SOL, XLM, DOGE, LTC, ADA, AVAX, ALGO, ATOM, TRX, HBAR, DOT, VET, TON, MATIC, CRO, XDC, DGB, CSPR, CKB, ZIL, and XVG. Go to Settings → Subscription → Pay with Crypto, select your chain, and we show you the exact amount (priced live via CoinGecko) and the wallet address to send to. For XRP and RLUSD, you also get a unique destination tag to match your payment. Our system verifies your payment on-chain and activates your subscription immediately. No KYC, no bank account, no credit card needed — just send crypto and you're upgraded. Card payments via Stripe are available as a fallback.",
      },
      {
        q: "Why should I pay with crypto instead of a credit card?",
        a: "Because we practice what we preach. CryptoOwnBank exists to help you become your own bank — so we built our own payment rails to work the same way. When you pay with crypto: (1) No middleman takes a cut — credit card networks charge 2.9% + $0.30 per transaction; crypto costs fractions of a penny. (2) No bank required — you don't need a bank account, credit check, or card issuer's permission to be a member. (3) Privacy — your payment is verified on-chain, not routed through Visa, Mastercard, or a payment processor that logs your purchase history. (4) Unstoppable — no chargebacks, no frozen accounts, no processor deciding you can't buy a crypto service. (5) Global — members anywhere in the world can pay in seconds, regardless of their local banking system. (6) Settlement in seconds — your subscription activates as soon as the blockchain confirms, not after a 2-3 day card settlement window. Every crypto payment goes directly to our cold wallet addresses — the same non-custodial architecture we recommend for you. Stripe card payments exist as a fallback for members who aren't on-chain yet, but our goal is to help you get there.",
      },
      {
