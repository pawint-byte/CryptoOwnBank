...
- [ ] **Automated Tax-Loss Harvesting** — Added to public roadmap (Horizon). Scan positions for unrealized losses, surface harvest opportunities with estimated tax savings, flag wash sale windows. Member executes trades themselves. Building blocks exist: tax lots, cost basis, portfolio positions, market prices. Must include "not tax advice" disclaimers and wash sale rule warnings.
