...
- **RWA Yield Explorer** (`/rwa-yields`): Real-World Asset yield opportunities across Soil Protocol (XRPL), Ondo Finance (USDY/OUSG), Centrifuge, XDC/TradeFi, Maple Finance. Includes traditional vs tokenized yield comparison and risk education.
