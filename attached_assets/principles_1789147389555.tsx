          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <nav className="hidden items-center gap-4 text-sm text-muted-foreground md:flex" aria-label="Public documentation">
                ...
                <a href="/features/legacy-plan" className="hover:text-foreground hidden lg:inline">Legacy Plan</a>
                <a href="/security" className="hover:text-foreground">Security</a>
                <a href="/guardrails" className="hover:text-foreground hidden lg:inline">Guardrails</a>
                <a href="/roadmap" className="hover:text-foreground hidden lg:inline">Roadmap</a>
              </nav>
              <ThemeToggle />
              <a href="/signup">
                <Button size="sm" className="bg-[#00A4E4] hover:bg-[#00A4E4]/90 text-white" data-testid="button-create-account-header">
                  Create account
                </Button>
              </a>
            </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <footer className="mt-12 border-t pt-6 text-center text-sm text-muted-foreground">
            <nav className="flex flex-wrap justify-center gap-x-5 gap-y-2" aria-label="Public documentation footer">
              <a href="/pricing" className="hover:text-foreground">Pricing</a>
              <a href="/faq" className="hover:text-foreground">FAQ</a>
              <a href="/features/legacy-plan" className="hover:text-foreground">Legacy Plan</a>
              <a href="/security" className="hover:text-foreground">Security</a>
