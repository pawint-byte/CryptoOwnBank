...
export const faqGroups: FaqGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Your principal is protected in two ways: 1) Non-custodial design — keys never leave your cold wallet. 2) Soil vaults are backed by real-world assets (Treasuries, credit funds) with institutional-grade underwriting. Soil publishes fixed target APRs, but returns are not guaranteed — crypto/blockchain always carries risks (smart contract bugs, protocol changes, market events, counterparty/RWA risk). Always DYOR.",
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: "Is CryptoOwnBank a bank, broker, or trust company?",
        a: "No. CryptoOwnBank is non-custodial software — a dashboard and tooling layer for self-custody wallets and on-chain protocols. We are not a bank, broker-dealer, money transmitter, or trust company. We do not hold your assets, guarantee investment returns, or act as a fiduciary or estate attorney. Yield figures you see (for example Soil vault APRs) come from third-party protocols and are not guaranteed by CryptoOwnBank. The Legacy Plan stores encrypted recovery instructions you write — it is not a legal will, trust instrument, or custodial inheritance service.",
      },
      {
