    ...
    <div className="min-h-[100dvh] bg-[#f4f3ec] text-[#183338] selection:bg-[#d8eadf]">
      ...
      <header className="sticky top-0 z-30 border-b border-[#183338]/10 bg-[#f4f3ec]/95 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          ...
          <nav className="flex items-center gap-3" aria-label="Public documentation"><Link href="/pricing" className="hidden text-sm font-medium text-[#46636a] hover:text-[#183338] sm:block">Pricing</Link><Link href="/faq" className="hidden text-sm font-medium text-[#46636a] hover:text-[#183338] sm:block">FAQ</Link><Link href="/features/legacy-plan" className="hidden text-sm font-medium text-[#46636a] hover:text-[#183338] lg:block">Legacy Plan</Link><Link href="/security" className="hidden text-sm font-medium text-[#46636a] hover:text-[#183338] sm:block">Security</Link><Link href="/principles" className="hidden text-sm font-medium text-[#46636a] hover:text-[#183338] lg:block">Principles</Link><Link href="/guardrails" className="hidden text-sm font-medium text-[#46636a] hover:text-[#183338] lg:block">Guardrails</Link><Link href="/roadmap" className="hidden text-sm font-medium text-[#46636a] hover:text-[#183338] lg:block">Roadmap</Link><ThemeToggle /><Link href="/signup" className="rounded-full bg-[#d56b45] px-4 py-2 text-sm font-semibold text-[#fff8ed] transition-transform hover:-translate-y-0.5">Create account</Link></nav>
        </div>
      </header>
      <main>
      ...
      <footer className="border-t border-[#183338]/10 px-5 py-10"><div className="mx-auto flex max-w-6xl flex-col justify-between gap-5 text-sm text-[#46636a] md:flex-row"><p>CryptoOwnBank helps members organize, explain, construct, monitor, and record. Members decide and sign.</p><nav className="flex flex-wrap gap-x-5 gap-y-2"><Link href="/pricing">Pricing</Link><Link href="/faq">FAQ</Link><Link href="/features/legacy-plan">Legacy Plan</Link><Link href="/security">Security</Link><Link href="/principles">Principles</Link><Link href="/guardrails">Guardrails</Link><Link href="/roadmap">Roadmap</Link><Link href="/contact">Contact</Link></nav></div><p className="mx-auto mt-6 max-w-6xl text-xs leading-5 text-[#46636a]">CryptoOwnBank is non-custodial software and education for self-directed users. It does not hold funds or recovery credentials, provide legal, tax, or investment advice, promise returns, or imply FDIC or SIPC protection. Digital assets and third-party protocols involve risk.</p></footer>
    </div>
  );
}