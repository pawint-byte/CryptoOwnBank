...
const SEO: Record<Exclude<SeoLang, "en">, SeoMeta> = {
  es: {
    ...
    ogDescription:
      "El único panel cripto de autocustodia que resuelve la herencia, ofrece herramientas tipo banca de autocustodia y acceso a rendimiento en stablecoins (p. ej. 5-8% en protocolos de terceros; sin garantía). Sin custodia. Más de 190 países. Gratis para empezar.",
    locale: "es_ES",
  },
  pt: {
    title:
    ...
    ogDescription:
      "O único painel cripto de autocustódia que resolve a herança, oferece ferramentas tipo banca de autocustódia e acesso a rendimento em stablecoins (ex.: 5-8% em protocolos de terceiros; sem garantia). Sem custódia. Mais de 190 países. Grátis para começar.",
    locale: "pt_BR",
  },
  fr: {
    title:
    ...
    ogDescription:
      "Le seul tableau de bord crypto en autoconservation qui règle l'héritage, offre des outils de type banque en autocustodie et un accès au rendement en stablecoins (ex. 5-8% via des protocoles tiers ; sans garantie). Non dépositaire. Plus de 190 pays. Gratuit pour commencer.",
    locale: "fr_FR",
  },
  tr: {
    title:
    ...
    ogDescription:
      "Mirası çözen, kendi saklamalı bankacılık benzeri araçlar sunan ve stablecoin getirisine erişim sağlayan (ör. üçüncü taraf protokollerde %5-8; garanti yok) tek saklamasız kripto paneli. Saklamasız. 190+ ülke. Başlaması ücretsiz.",
    locale: "tr_TR",
  },
  hi: {
    title:
    ...
    ogDescription:
      "एकमात्र सेल्फ-कस्टडी क्रिप्टो डैशबोर्ड जो विरासत हल करता है, सेल्फ-कस्टडी बैंकिंग-जैसे टूल देता है और स्टेबलकॉइन यील्ड तक पहुँच देता है (जैसे तृतीय-पक्ष प्रोटोकॉल पर 5-8%; कोई गारंटी नहीं)। नॉन-कस्टोडियल। 190+ देश। शुरू करना मुफ़्त।",
    locale: "hi_IN",
  },
  zh: {
    ...
    ogDescription:
      "唯一一个解决继承问题、提供自我保管类银行工具并接入稳定币收益（例如第三方协议约5-8%；不保证收益）的自我保管加密仪表板。非托管。190多个国家。免费开始。",
    locale: "zh_CN",
  },
};


const EN_SEO: SeoMeta = {
  title:
    "CryptoOwnBank — Self-Custody Crypto Platform | Inheritance, Yield, Global Payments",
  description:
    "What happens to your crypto when you die? CryptoOwnBank solves it. Non-custodial platform with automatic crypto inheritance (Legacy Plan), RLUSD yield vaults, XRPL and Stellar DEX trading, global remittances, and cold-wallet portfolio tracking. Your keys, your crypto — even when you're gone.",
  ogTitle:
    "CryptoOwnBank — Be Your Own Bank | Non-Custodial Crypto Inheritance & Yield",
  ogDescription:
    "The only self-custody crypto dashboard that solves inheritance, offers banking-like self-custody tools, and access to stablecoin yields via third-party protocols (not guaranteed). Non-custodial. 190+ countries. Free to start.",
  locale: "en_US",
};

/** SEO head meta for a language (EN included). Safe for FAQ mirrors and sitemap-adjacent use. */
export function getSeoMeta(lang: SeoLang): SeoMeta {
  if (lang === "en") return EN_SEO;
  return SEO[lang];
}
