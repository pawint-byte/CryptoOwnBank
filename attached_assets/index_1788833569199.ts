...
app.use(
  helmet({
    ...
    // Allow crawlers / external fetchers to load public SEO assets (sitemap, robots)
    crossOriginResourcePolicy: { policy: "cross-origin" },
  }),
);

// Last-write wins for public SEO routes (Helmet + Replit/GFE can otherwise force CORP=same-origin)
